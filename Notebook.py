...
filename = 'groupeE.pkl'
clf_loaded = pickle.load(open(filename, 'rb'))

movieComments = pd.read_csv('Data/test_data.csv', sep='\t', header = None, encoding = "utf8")
movieCommentsLabels = pd.read_csv('Data/test_labels.csv', sep='\t', header = None, encoding = "utf8")
